...
abstract contract ERC1155Votes is ERC1155Supply{
     ...
     */
    function getVotes(address account) public view returns (uint256[]memory votes) {
        if (nextTokenId == 0 ){
     ...
     */
    function getPastVotes(address account, uint256 blockNumber) public view returns (uint256[] memory votes) {
